...
<div class="card-body">
<form method="POST" action="/academicos">
{{ csrf_field() }}
    ...
    <input type="text" id="titulo_profesional" name="titulo_profesional"><br>

    <label for="grado_academico">Grado academico: </label><br>
    <input type="text" id="grado_academico" name="grado_academico"><br>
    ...
    <input type="text" id="tipo_planta" name="tipo_planta"><br>
    ...
    <input type="submit" value="Agregar academico">
</form>
